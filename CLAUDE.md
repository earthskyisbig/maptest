...
| 2026-09-10 | 신통기획 후보지 보완 파이프라인: 정보몽땅 후보지 수집(fetch_sintong_sites.py, 145곳·2026년 26곳 위치도) → 필지 클릭 구역 그리기 도구(zone_editor_template.html·build_zone_editor.py → sintong_zone_editor.html, VWorld 연속지적도 JSONP·직접 그리기·면적 게이지) → merge_sintong_edits.py(union, 미작성은 면적 환산 원 자리표시) → 경매 지도 레이어 "신속통합기획 후보지(정보몽땅)" 기본 표시. 구역그리기.bat·지도열기.bat 추가 | scripts·_workspace·루트·course/10 | 서울플랜+ UQ120이 반기 갱신이라 2026년 선정 후보지가 지도에 없음(재개발닷컴·아실 대비) |
